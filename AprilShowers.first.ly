...
clarI = \relative c' {
  ...
  r4. e,8 ds4( e4 ) \bar "||" \mark \markup{ \box B \musicglyph #"scripts.segno" }
  ...
  b1( | as1) | b1~ | b1 | cs4 r2. | R1 | e4-. ds8 d r cs r b | 
    r4. e,8 ds4 e4 \bar "||" \mark \markup { \box F }
  ...
  \mark \markup { \musicglyph #"scripts.coda" Coda } fs4-- gs8 fs r gs r fs |
...
clarII = \relative c'' {
  ...
  r1 \bar "||" \mark \markup{ \box B \musicglyph #"scripts.segno" }
  ...
  r8 d4. a'4( gs) | b,-^ r8 bs-> r4 cs-^ | r1 \bar "||" \mark \markup { \box C }
  ...
  \mark \markup { \musicglyph #"scripts.coda" Coda } e4-- e8 ds r ds r d |
...
clarIII = \relative c' {
  ...
  d4 d r8 d r d | r d r d d2 | d4-. r8 e8 r4 r8 f8 | r8 f4. b,2 |
    ...
    b2( a2) |
  a2 d4-- d-- | d4-^ r8 ds-^ r4 e4-^ | r1 \bar "||" \mark \markup { \box C }
  ...
  \mark \markup { \musicglyph #"scripts.coda" Coda } b2( a2) | a2 d4-- d4-- |
...
bassClar = \relative c' {
  ...
  b2 e,2 | g4-^ r8 gs-^ r4 a4-^ | r1 \bar "||" \mark \markup { \box C }
  ...
  \mark \markup { \musicglyph #"scripts.coda" Coda } cs2( bs2) | b2 e4( d4) |
...
music = {
  <<
     \new Staff  \transpose a  c'   \clarI
     \new Staff  \transpose a  c'   \clarII
     \new Staff  \transpose a  c'   \clarIII
     \new Staff  \transpose a  c'   \bassClar
  >>
}
